...
test(
    ...
    async function testScalableAndroidGeneration() {
        ...
        assert.match(generated, /methods = listOf\(APP_CURRENT_METHOD, APPEARANCE_CURRENT_METHOD, APPS_LAUNCH_METHOD, APPS_LIST_METHOD, EXTERNAL_OPEN_METHOD, NETWORK_STATUS_METHOD, PLATFORM_STATUS_METHOD, SYSTEM_PING_METHOD, TERMINAL_CLOSE_METHOD, TERMINAL_LIST_METHOD, TERMINAL_RESIZE_METHOD, TERMINAL_SIGNAL_METHOD, TERMINAL_START_METHOD, TERMINAL_WRITE_METHOD, USER_CURRENT_METHOD, VERSION_CURRENT_METHOD\)/);
