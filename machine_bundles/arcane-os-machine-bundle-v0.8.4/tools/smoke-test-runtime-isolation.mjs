...
for (const token of [
  ...
  'is_canonical_app_id(ARCANE_APP)',
  'g_get_user_data_dir(), "arcane-os", "apps", ARCANE_APP, "webkit"',
  'g_get_user_cache_dir(), "arcane-os", "apps", ARCANE_APP, "webkit"',
  'webkit_network_session_new(host->web_data_dir, host->web_cache_dir)',
