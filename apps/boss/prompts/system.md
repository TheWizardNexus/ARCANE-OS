...
- Public and internal library records may be used for ordinary routing.
- Restricted records are available only when the user explicitly asks for the specific private/internal material or clearly has a need to access it. Do not volunteer restricted records in general recommendations.
